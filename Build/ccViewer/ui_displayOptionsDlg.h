...
public:
    ...
    {
        DisplayOptionsDlg->setWindowTitle(QApplication::translate("DisplayOptionsDlg", "Display options", nullptr));
        sunLightGroup->setTitle(QApplication::translate("DisplayOptionsDlg", "Light", nullptr));
        ambientColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_3->setText(QApplication::translate("DisplayOptionsDlg", "Ambient", nullptr));
        specularColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_4->setText(QApplication::translate("DisplayOptionsDlg", "Specular", nullptr));
        diffuseColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_5->setText(QApplication::translate("DisplayOptionsDlg", "Diffuse", nullptr));
#ifndef QT_NO_TOOLTIP
        doubleSidedCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "<html><head/><body><p>Whether to use a double-sided light model or not</p><p>(if disabled, triangles will appear black when looked from behind)</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        doubleSidedCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "double-sided", nullptr));
        sunLightGroup_2->setTitle(QApplication::translate("DisplayOptionsDlg", "Default Materials", nullptr));
        meshFrontColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_6->setText(QApplication::translate("DisplayOptionsDlg", "Mesh Front", nullptr));
        meshBackColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_7->setText(QApplication::translate("DisplayOptionsDlg", "Mesh Back", nullptr));
        meshSpecularColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_12->setText(QApplication::translate("DisplayOptionsDlg", "Mesh specular", nullptr));
        pointsColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_8->setText(QApplication::translate("DisplayOptionsDlg", "Points", nullptr));
        othersGroup->setTitle(QApplication::translate("DisplayOptionsDlg", "Colors", nullptr));
        bkgColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_2->setText(QApplication::translate("DisplayOptionsDlg", "Background", nullptr));
        bbColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_9->setText(QApplication::translate("DisplayOptionsDlg", "Bounding-box", nullptr));
        textColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label->setText(QApplication::translate("DisplayOptionsDlg", "Text", nullptr));
#ifndef QT_NO_TOOLTIP
        enableGradientCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Gradient goes from 'background' color to inverse of 'Points' color", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        enableGradientCheckBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "Gradient goes from 'background' color to inverse of 'Points' color", nullptr));
#endif // QT_NO_STATUSTIP
        enableGradientCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "display gradient background", nullptr));
        toolBox->setItemText(toolBox->indexOf(pageColorAndMatOptions), QApplication::translate("DisplayOptionsDlg", "Colors and Materials", nullptr));
        colorScaleShowHistogramCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Show histogram next to color ramp", nullptr));
        useColorScaleShaderCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Enable shader for faster display (ATI cards: use at your own risk ;)", nullptr));
        label_10->setText(QApplication::translate("DisplayOptionsDlg", "Ramp width", nullptr));
        colorRampWidthSpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", " pixels", nullptr));
        toolBox->setItemText(toolBox->indexOf(pageSFOptions), QApplication::translate("DisplayOptionsDlg", "Color scale (scalar field)", nullptr));
        label_13->setText(QApplication::translate("DisplayOptionsDlg", "Label opacity", nullptr));
        labelOpacitySpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", "%", nullptr));
        label_16->setText(QApplication::translate("DisplayOptionsDlg", "Label font size", nullptr));
        label_20->setText(QApplication::translate("DisplayOptionsDlg", "background color", nullptr));
        labelBkgColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        label_15->setText(QApplication::translate("DisplayOptionsDlg", "Labels marker size", nullptr));
        label_18->setText(QApplication::translate("DisplayOptionsDlg", "marker color", nullptr));
        labelMarkerColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", nullptr));
        toolBox->setItemText(toolBox->indexOf(pageLabelsOptions), QApplication::translate("DisplayOptionsDlg", "Labels", nullptr));
        label_11->setText(QApplication::translate("DisplayOptionsDlg", "Default font size", nullptr));
        label_14->setText(QApplication::translate("DisplayOptionsDlg", "Displayed numbers precision", nullptr));
        label_17->setText(QApplication::translate("DisplayOptionsDlg", "Perspective zooming speed", nullptr));
#ifndef QT_NO_TOOLTIP
        zoomSpeedDoubleSpinBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Zoom/walk speed in perspective mode (default = 1.0)", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        decimateCloudBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big point clouds when moved", nullptr));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        decimateCloudBox->setWhatsThis(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big point clouds when moved", nullptr));
#endif // QT_NO_WHATSTHIS
        decimateCloudBox->setText(QApplication::translate("DisplayOptionsDlg", "Decimate clouds over", nullptr));
#ifndef QT_NO_TOOLTIP
        maxCloudSizeDoubleSpinBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Minimum number of points to activate decimation", nullptr));
#endif // QT_NO_TOOLTIP
        maxCloudSizeDoubleSpinBox->setPrefix(QApplication::translate("DisplayOptionsDlg", "> ", nullptr));
        maxCloudSizeDoubleSpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", " M.", nullptr));
        label_21->setText(QApplication::translate("DisplayOptionsDlg", "points when moved", nullptr));
#ifndef QT_NO_STATUSTIP
        decimateMeshBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big meshes when moved", nullptr));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        decimateMeshBox->setWhatsThis(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big meshes when moved", nullptr));
#endif // QT_NO_WHATSTHIS
        decimateMeshBox->setText(QApplication::translate("DisplayOptionsDlg", "Decimate meshes over", nullptr));
#ifndef QT_NO_TOOLTIP
        maxMeshSizeDoubleSpinBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Minimum number of triangles to activate decimation", nullptr));
#endif // QT_NO_TOOLTIP
        maxMeshSizeDoubleSpinBox->setPrefix(QApplication::translate("DisplayOptionsDlg", "> ", nullptr));
        maxMeshSizeDoubleSpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", " M.", nullptr));
        label_19->setText(QApplication::translate("DisplayOptionsDlg", "triangles when moved", nullptr));
        drawRoundedPointsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Draw rounded points (slower)", nullptr));
        useVBOCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Try to load clouds on GPU for faster display", nullptr));
#ifndef QT_NO_TOOLTIP
        showCrossCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "A cross is displayed in the middle of the screen", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        showCrossCheckBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "A cross is displayed in the middle of the screen", nullptr));
#endif // QT_NO_STATUSTIP
        showCrossCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Show middle screen cross", nullptr));
        autoDisplayNormalsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Automatically display normals at loading time (when available)", nullptr));
        useNativeDialogsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Use native load / save dialogs", nullptr));
        label_22->setText(QApplication::translate("DisplayOptionsDlg", "Auto-compute octree for picking", nullptr));
        autoComputeOctreeComboBox->setItemText(0, QApplication::translate("DisplayOptionsDlg", "Always", nullptr));
        autoComputeOctreeComboBox->setItemText(1, QApplication::translate("DisplayOptionsDlg", "Ask each time", nullptr));
        autoComputeOctreeComboBox->setItemText(2, QApplication::translate("DisplayOptionsDlg", "Never", nullptr));

#ifndef QT_NO_TOOLTIP
        autoComputeOctreeComboBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Octree computation can be long but the picking is then much faster", nullptr));
#endif // QT_NO_TOOLTIP
        toolBox->setItemText(toolBox->indexOf(pageOtherOptions), QApplication::translate("DisplayOptionsDlg", "Other options", nullptr));
        okButton->setText(QApplication::translate("DisplayOptionsDlg", "Ok", nullptr));
        applyButton->setText(QApplication::translate("DisplayOptionsDlg", "Apply", nullptr));
        resetButton->setText(QApplication::translate("DisplayOptionsDlg", "Reset", nullptr));
        cancelButton->setText(QApplication::translate("DisplayOptionsDlg", "Cancel", nullptr));
    } // retranslateUi
