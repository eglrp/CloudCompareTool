...
public:
    ...
    {
        MatchScalesDialog->setWindowTitle(QApplication::translate("MatchScalesDialog", "Match scales", nullptr));
#ifndef QT_NO_TOOLTIP
        groupBox->setToolTip(QApplication::translate("MatchScalesDialog", "Choose the reference entity (its scale won't change)", nullptr));
#endif // QT_NO_TOOLTIP
        groupBox->setTitle(QApplication::translate("MatchScalesDialog", "Reference entity", nullptr));
        groupBox_2->setTitle(QApplication::translate("MatchScalesDialog", "Matching criterion", nullptr));
#ifndef QT_NO_TOOLTIP
        bbMaxDimRadioButton->setToolTip(QApplication::translate("MatchScalesDialog", "The scaling ratio will be deduced from the largest bounding-box dimension", nullptr));
#endif // QT_NO_TOOLTIP
        bbMaxDimRadioButton->setText(QApplication::translate("MatchScalesDialog", "max bounding-box dimension", nullptr));
#ifndef QT_NO_TOOLTIP
        bbVolumeRadioButton->setToolTip(QApplication::translate("MatchScalesDialog", "The scaling ratio will be deduced from the bounding-box volume", nullptr));
#endif // QT_NO_TOOLTIP
        bbVolumeRadioButton->setText(QApplication::translate("MatchScalesDialog", "bounding-box volume", nullptr));
#ifndef QT_NO_TOOLTIP
        pcaRadioButton->setToolTip(QApplication::translate("MatchScalesDialog", "The scaling ratio will be deduced from the principal cloud dimension (by PCA analysis)", nullptr));
#endif // QT_NO_TOOLTIP
        pcaRadioButton->setText(QApplication::translate("MatchScalesDialog", "principal dimension (PCA)", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        icpRadioButton->setText(QApplication::translate("MatchScalesDialog", "ICP (only the scale will be applied)", nullptr));
#ifndef QT_NO_TOOLTIP
        icpGroupBox->setToolTip(QApplication::translate("MatchScalesDialog", "Parameters for ICP registration", nullptr));
#endif // QT_NO_TOOLTIP
        icpGroupBox->setTitle(QApplication::translate("MatchScalesDialog", "ICP parameters", nullptr));
        label_2->setText(QApplication::translate("MatchScalesDialog", "RMS difference", nullptr));
#ifndef QT_NO_TOOLTIP
        rmsDifferenceLineEdit->setToolTip(QApplication::translate("MatchScalesDialog", "Set the minimum RMS improvement between 2 consecutive iterations (below which the registration process will stop).", nullptr));
#endif // QT_NO_TOOLTIP
        rmsDifferenceLineEdit->setText(QApplication::translate("MatchScalesDialog", "1.0e-5", nullptr));
#ifndef QT_NO_TOOLTIP
        overlapSpinBox->setToolTip(QApplication::translate("MatchScalesDialog", "Rough estimation of the final overlap ratio of the data cloud (the smaller, the better the initial registration should be!)", nullptr));
#endif // QT_NO_TOOLTIP
        overlapSpinBox->setSuffix(QApplication::translate("MatchScalesDialog", "%", nullptr));
#ifndef QT_NO_TOOLTIP
        label_4->setToolTip(QApplication::translate("MatchScalesDialog", "Rough estimation of the final overlap ratio of the data cloud (the smaller, the better the initial registration should be!)", nullptr));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("MatchScalesDialog", "Final overlap", nullptr));
    } // retranslateUi
