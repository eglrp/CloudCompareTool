...
public:
    ...
    {
        SFEditDlg->setWindowTitle(QApplication::translate("SFEditDlg", "SF Values", nullptr));
        dispLabel->setText(QApplication::translate("SFEditDlg", "displayed", nullptr));
        satLabel->setText(QApplication::translate("SFEditDlg", "saturation", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("SFEditDlg", "Display ranges", nullptr));
#ifndef QT_NO_TOOLTIP
        nanInGreyCheckBox->setToolTip(QApplication::translate("SFEditDlg", "hidden otherwise...", nullptr));
#endif // QT_NO_TOOLTIP
        nanInGreyCheckBox->setText(QApplication::translate("SFEditDlg", "show NaN/out of range values in grey", nullptr));
        alwaysShow0CheckBox->setText(QApplication::translate("SFEditDlg", "always show 0 in color scale", nullptr));
        symmetricalScaleCheckBox->setText(QApplication::translate("SFEditDlg", "symmetrical color scale", nullptr));
        logScaleCheckBox->setText(QApplication::translate("SFEditDlg", "log scale", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("SFEditDlg", "Parameters", nullptr));
    } // retranslateUi
