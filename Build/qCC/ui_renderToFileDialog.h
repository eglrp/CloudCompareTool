...
public:
    ...
    {
        RenderToFileDialog->setWindowTitle(QApplication::translate("RenderToFileDialog", "Render to file", nullptr));
        label->setText(QApplication::translate("RenderToFileDialog", "Filename", nullptr));
        chooseFileButton->setText(QApplication::translate("RenderToFileDialog", "...", nullptr));
        label_2->setText(QApplication::translate("RenderToFileDialog", "Zoom", nullptr));
        label_3->setText(QApplication::translate("RenderToFileDialog", "Result:", nullptr));
        finalSizeLabel->setText(QApplication::translate("RenderToFileDialog", "(? x ?)", nullptr));
        dontScaleFeaturesCheckBox->setText(QApplication::translate("RenderToFileDialog", "Don't scale features (e.g. points size, lines thickness, text, etc.)", nullptr));
        renderOverlayItemsCheckBox->setText(QApplication::translate("RenderToFileDialog", "Render overlay items (scale, trihedron, etc.)", nullptr));
    } // retranslateUi
