...
public:
    ...
    {
        ComparisonDialog->setWindowTitle(QApplication::translate("ComparisonDialog", "Distance computation", nullptr));
        label->setText(QApplication::translate("ComparisonDialog", "Compared", nullptr));
        label_2->setText(QApplication::translate("ComparisonDialog", "Reference", nullptr));
        preciseGroupBox->setTitle(QApplication::translate("ComparisonDialog", "Precise results", nullptr));
#ifndef QT_NO_TOOLTIP
        label_5->setToolTip(QApplication::translate("ComparisonDialog", "Level of subdivision used for computing the distances", nullptr));
#endif // QT_NO_TOOLTIP
        label_5->setText(QApplication::translate("ComparisonDialog", "Octree level", nullptr));
#ifndef QT_NO_TOOLTIP
        maxDistCheckBox->setToolTip(QApplication::translate("ComparisonDialog", "Acceleration: distances above this limit won't be computed accurately", nullptr));
#endif // QT_NO_TOOLTIP
        maxDistCheckBox->setText(QApplication::translate("ComparisonDialog", "max. distance", nullptr));
#ifndef QT_NO_TOOLTIP
        maxSearchDistSpinBox->setToolTip(QApplication::translate("ComparisonDialog", "Acceleration: distances above this limit won't be computed accurately", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        signedDistCheckBox->setToolTip(QApplication::translate("ComparisonDialog", "compute signed distances (slower)", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        signedDistCheckBox->setStatusTip(QApplication::translate("ComparisonDialog", "compute signed distances (slower)", nullptr));
#endif // QT_NO_STATUSTIP
        signedDistCheckBox->setText(QApplication::translate("ComparisonDialog", "signed distances", nullptr));
        flipNormalsCheckBox->setText(QApplication::translate("ComparisonDialog", "flip normals", nullptr));
#ifndef QT_NO_TOOLTIP
        split3DCheckBox->setToolTip(QApplication::translate("ComparisonDialog", "Generate 3 supplementary scalar fields with distances along each dimension", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        split3DCheckBox->setStatusTip(QApplication::translate("ComparisonDialog", "Generate 3 supplementary scalar fields with distances along each dimension", nullptr));
#endif // QT_NO_STATUSTIP
        split3DCheckBox->setText(QApplication::translate("ComparisonDialog", "split X,Y and Z components", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        filterVisibilityCheckBox->setText(QApplication::translate("ComparisonDialog", "use reference sensor to filter hidden points", nullptr));
        multiThreadedCheckBox->setText(QApplication::translate("ComparisonDialog", "multi-threaded", nullptr));
        label_6->setText(QApplication::translate("ComparisonDialog", "max thread count", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        maxThreadCountSpinBox->setSuffix(QApplication::translate("ComparisonDialog", " / 8", nullptr));
        preciseResultsTabWidget->setTabText(preciseResultsTabWidget->indexOf(generalParamsTab), QApplication::translate("ComparisonDialog", "General parameters", nullptr));
        label_3->setText(QApplication::translate("ComparisonDialog", "Local model", nullptr));
        lmKNNRadioButton->setText(QApplication::translate("ComparisonDialog", "Points (kNN)", nullptr));
        lmRadiusRadioButton->setText(QApplication::translate("ComparisonDialog", "Radius (Sphere)", nullptr));
#ifndef QT_NO_TOOLTIP
        lmOptimizeCheckBox->setToolTip(QApplication::translate("ComparisonDialog", "faster but more ... approximate", nullptr));
#endif // QT_NO_TOOLTIP
        lmOptimizeCheckBox->setText(QApplication::translate("ComparisonDialog", "use the same model for nearby points", nullptr));
        preciseResultsTabWidget->setTabText(preciseResultsTabWidget->indexOf(localModelingTab), QApplication::translate("ComparisonDialog", "Local modeling", nullptr));
        label_4->setText(QApplication::translate("ComparisonDialog", "Warning: approximate results are only provided\n"
"to help you set the general parameters", nullptr));
        histoButton->setText(QApplication::translate("ComparisonDialog", "...", nullptr));
        preciseResultsTabWidget->setTabText(preciseResultsTabWidget->indexOf(approxTab), QApplication::translate("ComparisonDialog", "Approx. results", nullptr));
        computeButton->setText(QApplication::translate("ComparisonDialog", "Compute", nullptr));
        okButton->setText(QApplication::translate("ComparisonDialog", "Ok", nullptr));
        cancelButton->setText(QApplication::translate("ComparisonDialog", "Cancel", nullptr));
    } // retranslateUi
