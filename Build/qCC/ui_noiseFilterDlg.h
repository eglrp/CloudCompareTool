...
public:
    ...
    {
        NoiseFilterDialog->setWindowTitle(QApplication::translate("NoiseFilterDialog", "Filter noise", nullptr));
        groupBox->setTitle(QApplication::translate("NoiseFilterDialog", "Neighbors", nullptr));
        knnRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Points (kNN)", nullptr));
        radiusRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Radius (Sphere)", nullptr));
        groupBox_2->setTitle(QApplication::translate("NoiseFilterDialog", "Max error", nullptr));
        relativeRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Relative", nullptr));
        absErrorRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Absolute", nullptr));
        removeIsolatedPointsCheckBox->setText(QApplication::translate("NoiseFilterDialog", "Remove isolated points", nullptr));
    } // retranslateUi
