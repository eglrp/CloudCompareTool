...
public:
    ...
    {
        GlobalShiftSettingsDialog->setWindowTitle(QApplication::translate("GlobalShiftSettingsDialog", "Global Shift settings", nullptr));
...
"Note: the diagonal is not tested at loading time.", nullptr));
        label_3->setText(QApplication::translate("GlobalShiftSettingsDialog", "Global Shift & Scale triggering limits:", nullptr));
        label->setText(QApplication::translate("GlobalShiftSettingsDialog", "Max absolute coordinate", nullptr));
#ifndef QT_NO_TOOLTIP
        maxAbsCoordSpinBox->setToolTip(QApplication::translate("GlobalShiftSettingsDialog", "CloudCompare will suggest to apply a Global Shift to the loaded entities if their coordinates are above this limit", nullptr));
#endif // QT_NO_TOOLTIP
        maxAbsCoordSpinBox->setSuffix(QString());
        maxAbsCoordSpinBox->setPrefix(QApplication::translate("GlobalShiftSettingsDialog", "10^", nullptr));
        label_2->setText(QApplication::translate("GlobalShiftSettingsDialog", "Max entity diagonal", nullptr));
#ifndef QT_NO_TOOLTIP
        maxAbsDiagSpinBox->setToolTip(QApplication::translate("GlobalShiftSettingsDialog", "CloudCompare will suggest to apply a Global Scale to the loaded entities if their bounding-box diagonal is above this limit", nullptr));
#endif // QT_NO_TOOLTIP
        maxAbsDiagSpinBox->setSuffix(QString());
        maxAbsDiagSpinBox->setPrefix(QApplication::translate("GlobalShiftSettingsDialog", "10^", nullptr));
    } // retranslateUi
