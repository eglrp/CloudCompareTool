...
public:
    ...
    {
        ColorScaleEditorDlg->setWindowTitle(QApplication::translate("ColorScaleEditorDlg", "Color Scale Editor", nullptr));
        label->setText(QApplication::translate("ColorScaleEditorDlg", "Current", nullptr));
#ifndef QT_NO_TOOLTIP
        exportToolButton->setToolTip(QApplication::translate("ColorScaleEditorDlg", "Export color scale to a file", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        importToolButton->setToolTip(QApplication::translate("ColorScaleEditorDlg", "Import color scale from a file", nullptr));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("ColorScaleEditorDlg", "Mode", nullptr));
        scaleModeComboBox->setItemText(0, QApplication::translate("ColorScaleEditorDlg", "relative", nullptr));
        scaleModeComboBox->setItemText(1, QApplication::translate("ColorScaleEditorDlg", "absolute", nullptr));

        renameToolButton->setText(QApplication::translate("ColorScaleEditorDlg", "Rename", nullptr));
        saveToolButton->setText(QApplication::translate("ColorScaleEditorDlg", "Save", nullptr));
        deleteToolButton->setText(QApplication::translate("ColorScaleEditorDlg", "Delete", nullptr));
        copyToolButton->setText(QApplication::translate("ColorScaleEditorDlg", "Copy", nullptr));
        newToolButton->setText(QApplication::translate("ColorScaleEditorDlg", "New", nullptr));
        lockWarningLabel->setText(QApplication::translate("ColorScaleEditorDlg", "(this ramp is locked - copy it before editing it)", nullptr));
        selectedSliderGroupBox->setTitle(QApplication::translate("ColorScaleEditorDlg", "Selected slider", nullptr));
        label_3->setText(QApplication::translate("ColorScaleEditorDlg", "Color", nullptr));
        label_2->setText(QApplication::translate("ColorScaleEditorDlg", "Value", nullptr));
        valueLabel->setText(QApplication::translate("ColorScaleEditorDlg", "(32%)", nullptr));
        customLabelsGroupBox->setTitle(QApplication::translate("ColorScaleEditorDlg", "Custom labels (one value per line)", nullptr));
        customLabelsPlainTextEdit->setPlainText(QApplication::translate("ColorScaleEditorDlg", "(auto)", nullptr));
        applyPushButton->setText(QApplication::translate("ColorScaleEditorDlg", "Apply", nullptr));
        closePushButton->setText(QApplication::translate("ColorScaleEditorDlg", "Close", nullptr));
    } // retranslateUi
