...
public:
    ...
    {
        ExportCoordToSFDlg->setWindowTitle(QApplication::translate("ExportCoordToSFDlg", "Export coordinates to SF", nullptr));
        label->setText(QApplication::translate("ExportCoordToSFDlg", "Export", nullptr));
        xCheckBox->setText(QApplication::translate("ExportCoordToSFDlg", "X", nullptr));
        yCheckBox->setText(QApplication::translate("ExportCoordToSFDlg", "Y", nullptr));
        zCheckBox->setText(QApplication::translate("ExportCoordToSFDlg", "Z", nullptr));
        warningLabel->setText(QApplication::translate("ExportCoordToSFDlg", "Warning, already existing SF(s) with same name will be overwritten", nullptr));
    } // retranslateUi
