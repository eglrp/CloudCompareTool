...
public:
    ...
    void retranslateUi(QDialog *GraphicalTransformationDlg)
    {
        ...
        razButton->setText(QApplication::translate("GraphicalTransformationDlg", "...", nullptr));
        okButton->setText(QApplication::translate("GraphicalTransformationDlg", "...", nullptr));
        cancelButton->setText(QApplication::translate("GraphicalTransformationDlg", "...", nullptr));
        label->setText(QApplication::translate("GraphicalTransformationDlg", "Rotation", nullptr));
        rotComboBox->setItemText(0, QApplication::translate("GraphicalTransformationDlg", "XYZ", nullptr));
        rotComboBox->setItemText(1, QApplication::translate("GraphicalTransformationDlg", "X", nullptr));
        rotComboBox->setItemText(2, QApplication::translate("GraphicalTransformationDlg", "Y", nullptr));
        rotComboBox->setItemText(3, QApplication::translate("GraphicalTransformationDlg", "Z", nullptr));

        TxCheckBox->setText(QApplication::translate("GraphicalTransformationDlg", "Tx", nullptr));
        TyCheckBox->setText(QApplication::translate("GraphicalTransformationDlg", "Ty", nullptr));
        TzCheckBox->setText(QApplication::translate("GraphicalTransformationDlg", "Tz", nullptr));
    } // retranslateUi
