...
public:
    ...
    {
        ApplyTransformationDialog->setWindowTitle(QApplication::translate("ApplyTransformationDialog", "Apply transformation", nullptr));
        label->setText(QApplication::translate("ApplyTransformationDialog", "Enter 4x4 matrix values:", nullptr));
#ifndef QT_NO_TOOLTIP
        fromFileToolButton->setToolTip(QApplication::translate("ApplyTransformationDialog", "Load matrix from ascii file", nullptr));
#endif // QT_NO_TOOLTIP
        fromFileToolButton->setText(QApplication::translate("ApplyTransformationDialog", "ASCII file", nullptr));
#ifndef QT_NO_TOOLTIP
        fromClipboardToolButton->setToolTip(QApplication::translate("ApplyTransformationDialog", "Paste clipboard contents", nullptr));
#endif // QT_NO_TOOLTIP
        fromClipboardToolButton->setText(QApplication::translate("ApplyTransformationDialog", "clipboard", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        fromDipDipDirToolButton->setText(QApplication::translate("ApplyTransformationDialog", "dip / dip direction", nullptr));
        helpToolButton->setText(QApplication::translate("ApplyTransformationDialog", "help", nullptr));
...
"0.000000	0.000000	0.000000	1.000000", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("ApplyTransformationDialog", "Matrix 4x4", nullptr));
        rotAxisGroupBox->setTitle(QApplication::translate("ApplyTransformationDialog", "Rotation axis", nullptr));
        rxAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "X:", nullptr));
        ryAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Y:", nullptr));
        rzAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Z:", nullptr));
        rotAngleGroupBox->setTitle(QApplication::translate("ApplyTransformationDialog", "Rotation angle (degrees)", nullptr));
        rAngleDoubleSpinBox->setSuffix(QApplication::translate("ApplyTransformationDialog", " deg.", nullptr));
        transGroupBox->setTitle(QApplication::translate("ApplyTransformationDialog", "Translation", nullptr));
        txAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "X:", nullptr));
        tyAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Y:", nullptr));
        tzAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Z:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("ApplyTransformationDialog", "Axis, Angle", nullptr));
        eulerAnglesGroupBox->setTitle(QApplication::translate("ApplyTransformationDialog", "Angles", nullptr));
        ePhiDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Phi:", nullptr));
        eThetaDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Theta:", nullptr));
        ePsiDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Psi:", nullptr));
        eulerTransGroupBox->setTitle(QApplication::translate("ApplyTransformationDialog", "Translation", nullptr));
        etxAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "X:", nullptr));
        etyAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Y:", nullptr));
        etzAxisDoubleSpinBox->setPrefix(QApplication::translate("ApplyTransformationDialog", "Z:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("ApplyTransformationDialog", "Euler angles", nullptr));
        inverseCheckBox->setText(QApplication::translate("ApplyTransformationDialog", "Apply inverse transformation", nullptr));
    } // retranslateUi
