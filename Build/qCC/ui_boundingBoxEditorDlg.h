...
public:
    ...
    {
        BoundingBoxEditorDialog->setWindowTitle(QApplication::translate("BoundingBoxEditorDialog", "Bounding Box Editor", nullptr));
        pointTypeComboBox->setItemText(0, QApplication::translate("BoundingBoxEditorDialog", "Min corner", nullptr));
        pointTypeComboBox->setItemText(1, QApplication::translate("BoundingBoxEditorDialog", "Center", nullptr));
        pointTypeComboBox->setItemText(2, QApplication::translate("BoundingBoxEditorDialog", "Max corner", nullptr));

        widthComboBox->setItemText(0, QApplication::translate("BoundingBoxEditorDialog", "Width", nullptr));

        xLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "X", nullptr));
        yLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "Y", nullptr));
        zLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "Z", nullptr));
        warningLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "Warning, this box doesn't include the cloud bounding-box!", nullptr));
        oriGroupBox->setTitle(QApplication::translate("BoundingBoxEditorDialog", "Orientation", nullptr));
#ifndef QT_NO_TOOLTIP
        oriZCheckBox->setToolTip(QApplication::translate("BoundingBoxEditorDialog", "automatically compute Z if checked", nullptr));
#endif // QT_NO_TOOLTIP
        oriZCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "Z", nullptr));
#ifndef QT_NO_TOOLTIP
        oriYCheckBox->setToolTip(QApplication::translate("BoundingBoxEditorDialog", "automatically compute Y if checked", nullptr));
#endif // QT_NO_TOOLTIP
        oriYCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "Y", nullptr));
#ifndef QT_NO_TOOLTIP
        oriXCheckBox->setToolTip(QApplication::translate("BoundingBoxEditorDialog", "automatically compute X if checked", nullptr));
#endif // QT_NO_TOOLTIP
        oriXCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "X", nullptr));
        keepSquareCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "keep square", nullptr));
        defaultPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "Default", nullptr));
        lastPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "Last", nullptr));
        okPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "OK", nullptr));
        cancelPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "Cancel", nullptr));
    } // retranslateUi
