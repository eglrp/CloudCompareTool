...
public:
    ...
    void setupUi(QDialog *SectionExtractionDlg)
    {
        ...
        vertAxisComboBox->addItem(QString());
        vertAxisComboBox->addItem(QString());
        vertAxisComboBox->addItem(QString());
    ...
    void retranslateUi(QDialog *SectionExtractionDlg)
    {
...
#endif // QT_NO_TOOLTIP
        undoToolButton->setText(QApplication::translate("SectionExtractionDlg", "raz", nullptr));
#ifndef QT_NO_TOOLTIP
        ...
        vertAxisComboBox->setItemText(0, QApplication::translate("SectionExtractionDlg", "X", nullptr));
        vertAxisComboBox->setItemText(1, QApplication::translate("SectionExtractionDlg", "Y", nullptr));
        vertAxisComboBox->setItemText(2, QApplication::translate("SectionExtractionDlg", "Z", nullptr));
