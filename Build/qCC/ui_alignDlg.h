...
public:
    ...
    {
        AlignDialog->setWindowTitle(QApplication::translate("AlignDialog", "Clouds alignment", nullptr));
        groupBox_5->setTitle(QApplication::translate("AlignDialog", "Model and data", nullptr));
        label_10->setText(QApplication::translate("AlignDialog", "Data:", nullptr));
#ifndef QT_NO_TOOLTIP
        dataCloud->setToolTip(QApplication::translate("AlignDialog", "the data cloud is the entity to align with the model cloud: it will be displaced (green cloud)", nullptr));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("AlignDialog", "Model:", nullptr));
#ifndef QT_NO_TOOLTIP
        modelCloud->setToolTip(QApplication::translate("AlignDialog", "the model cloud is the reference: it won't move (red cloud)", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        swapButton->setToolTip(QApplication::translate("AlignDialog", "press once to exchange model and data clouds", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        swapButton->setStatusTip(QApplication::translate("AlignDialog", "press once to exchange model and data clouds", nullptr));
#endif // QT_NO_STATUSTIP
        swapButton->setText(QApplication::translate("AlignDialog", "swap", nullptr));
        groupBox->setTitle(QApplication::translate("AlignDialog", "Alignment parameters", nullptr));
        label->setText(QApplication::translate("AlignDialog", "Number of trials:", nullptr));
#ifndef QT_NO_TOOLTIP
        nbTries->setToolTip(QApplication::translate("AlignDialog", "Number of 4 points bases tested to find the best rigid transform. Great values may lead to long computation time.", nullptr));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("AlignDialog", "Overlap:", nullptr));
#ifndef QT_NO_TOOLTIP
        overlap->setToolTip(QApplication::translate("AlignDialog", "Rough estimation of the two clouds overlap rate (between 0 and 1)", nullptr));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("AlignDialog", "Delta:", nullptr));
#ifndef QT_NO_TOOLTIP
        delta->setToolTip(QApplication::translate("AlignDialog", "Estimation of the distance wished between the two clouds after registration.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        deltaEstimation->setToolTip(QApplication::translate("AlignDialog", "The computer will estimate the best delta parameter", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        deltaEstimation->setStatusTip(QApplication::translate("AlignDialog", "The computer will estimate the best delta parameter", nullptr));
#endif // QT_NO_STATUSTIP
        deltaEstimation->setText(QApplication::translate("AlignDialog", "Estimate", nullptr));
#ifndef QT_NO_TOOLTIP
        isNbCandLimited->setToolTip(QApplication::translate("AlignDialog", "For each attempt (see above parameter), candidate bases are found. If there are too much candidates, the program may take a long time to finish. Check this box to bound the number of candidates.", nullptr));
#endif // QT_NO_TOOLTIP
        isNbCandLimited->setText(QApplication::translate("AlignDialog", "Limit max. number of candidates", nullptr));
#ifndef QT_NO_TOOLTIP
        nbMaxCandidates->setToolTip(QApplication::translate("AlignDialog", "Maximal number of candidates allowed (check the left box to use this parameter)", nullptr));
#endif // QT_NO_TOOLTIP
        groupBox_2->setTitle(QApplication::translate("AlignDialog", "Sampling", nullptr));
        label_4->setText(QApplication::translate("AlignDialog", "Method:", nullptr));
        groupBox_3->setTitle(QApplication::translate("AlignDialog", "Data", nullptr));
        label_7->setText(QApplication::translate("AlignDialog", "None", nullptr));
        label_8->setText(QApplication::translate("AlignDialog", "All", nullptr));
#ifndef QT_NO_TOOLTIP
        dataSample->setToolTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the data cloud.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        dataSample->setStatusTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the data cloud.", nullptr));
#endif // QT_NO_STATUSTIP
        dataRemaining->setText(QApplication::translate("AlignDialog", "remaining points", nullptr));
        groupBox_4->setTitle(QApplication::translate("AlignDialog", "Model", nullptr));
        label_6->setText(QApplication::translate("AlignDialog", "None", nullptr));
        label_5->setText(QApplication::translate("AlignDialog", "All", nullptr));
#ifndef QT_NO_TOOLTIP
        modelSample->setToolTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the model cloud.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        modelSample->setStatusTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the model cloud.", nullptr));
#endif // QT_NO_STATUSTIP
        modelRemaining->setText(QApplication::translate("AlignDialog", "remaining points", nullptr));
    } // retranslateUi
