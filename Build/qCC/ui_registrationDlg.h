...
public:
    ...
    {
        RegistrationDialog->setWindowTitle(QApplication::translate("RegistrationDialog", "Clouds registration", nullptr));
        groupBox_5->setTitle(QApplication::translate("RegistrationDialog", "Role assignation", nullptr));
#ifndef QT_NO_TOOLTIP
        label_10->setToolTip(QApplication::translate("RegistrationDialog", "'data' entity", nullptr));
#endif // QT_NO_TOOLTIP
        label_10->setText(QApplication::translate("RegistrationDialog", "aligned", nullptr));
#ifndef QT_NO_TOOLTIP
        dataLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>entity to align (will be displaced)</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        dataLineEdit->setStatusTip(QApplication::translate("RegistrationDialog", "the data cloud is the entity to align with the model cloud : it will be displaced (red cloud)", nullptr));
#endif // QT_NO_STATUSTIP
        modelColorButton->setText(QString());
        dataColorButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        label_9->setToolTip(QApplication::translate("RegistrationDialog", "'model' entity", nullptr));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("RegistrationDialog", "reference", nullptr));
#ifndef QT_NO_TOOLTIP
        modelLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>reference entity (won't move)</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        modelLineEdit->setStatusTip(QApplication::translate("RegistrationDialog", "the model cloud is the reference : it won't move (yellow cloud)", nullptr));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_TOOLTIP
        swapButton->setToolTip(QApplication::translate("RegistrationDialog", "press once to exchange model and data clouds", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        swapButton->setStatusTip(QApplication::translate("RegistrationDialog", "press once to exchange model and data clouds", nullptr));
#endif // QT_NO_STATUSTIP
        swapButton->setText(QApplication::translate("RegistrationDialog", "swap", nullptr));
#ifndef QT_NO_TOOLTIP
        iterationsCriterion->setToolTip(QApplication::translate("RegistrationDialog", "By choosing this criterion, you can control the computation time.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        iterationsCriterion->setStatusTip(QApplication::translate("RegistrationDialog", "By choosing this criterion, you can control the computation time.", nullptr));
#endif // QT_NO_STATUSTIP
        iterationsCriterion->setText(QApplication::translate("RegistrationDialog", "Number of iterations", nullptr));
#ifndef QT_NO_TOOLTIP
        maxIterationCount->setToolTip(QApplication::translate("RegistrationDialog", "Set the maximal number of step for the algorithm regsitration computation .", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        errorCriterion->setToolTip(QApplication::translate("RegistrationDialog", "By choosing this criterion, you can control the quality of the result.", nullptr));
#endif // QT_NO_TOOLTIP
        errorCriterion->setText(QApplication::translate("RegistrationDialog", "RMS difference", nullptr));
#ifndef QT_NO_TOOLTIP
        rmsDifferenceLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "Set the minimum RMS improvement between 2 consecutive iterations (below which the registration process will stop).", nullptr));
#endif // QT_NO_TOOLTIP
        rmsDifferenceLineEdit->setText(QApplication::translate("RegistrationDialog", "1.0e-5", nullptr));
#ifndef QT_NO_TOOLTIP
        label_4->setToolTip(QApplication::translate("RegistrationDialog", "Rough estimation of the final overlap ratio of the data cloud (the smaller, the better the initial registration should be!)", nullptr));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("RegistrationDialog", "Final overlap", nullptr));
#ifndef QT_NO_TOOLTIP
        overlapSpinBox->setToolTip(QApplication::translate("RegistrationDialog", "Rough estimation of the final overlap ratio of the data cloud (the smaller, the better the initial registration should be!)", nullptr));
#endif // QT_NO_TOOLTIP
        overlapSpinBox->setSuffix(QApplication::translate("RegistrationDialog", "%", nullptr));
#ifndef QT_NO_STATUSTIP
        adjustScaleCheckBox->setStatusTip(QApplication::translate("RegistrationDialog", "Whether to adjust the scale of the 'data' entity", nullptr));
#endif // QT_NO_STATUSTIP
        adjustScaleCheckBox->setText(QApplication::translate("RegistrationDialog", "adjust scale", nullptr));
        label_6->setText(QApplication::translate("RegistrationDialog", "max thread count", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        maxThreadCountSpinBox->setSuffix(QApplication::translate("RegistrationDialog", " / 8", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabStdParams), QApplication::translate("RegistrationDialog", "Parameters", nullptr));
        label->setText(QApplication::translate("RegistrationDialog", "Random sampling limit", nullptr));
#ifndef QT_NO_TOOLTIP
        randomSamplingLimitSpinBox->setToolTip(QApplication::translate("RegistrationDialog", "Above this limit, clouds are randomly resampled at each iteration", nullptr));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("RegistrationDialog", "Rotation", nullptr));
        rotComboBox->setItemText(0, QApplication::translate("RegistrationDialog", "XYZ", nullptr));
        rotComboBox->setItemText(1, QApplication::translate("RegistrationDialog", "X", nullptr));
        rotComboBox->setItemText(2, QApplication::translate("RegistrationDialog", "Y", nullptr));
        rotComboBox->setItemText(3, QApplication::translate("RegistrationDialog", "Z", nullptr));

        label_3->setText(QApplication::translate("RegistrationDialog", "Translation", nullptr));
        TxCheckBox->setText(QApplication::translate("RegistrationDialog", "Tx", nullptr));
        TyCheckBox->setText(QApplication::translate("RegistrationDialog", "Ty", nullptr));
        TzCheckBox->setText(QApplication::translate("RegistrationDialog", "Tz", nullptr));
#ifndef QT_NO_TOOLTIP
        pointsRemoval->setToolTip(QApplication::translate("RegistrationDialog", "Chose this option to remove points that are likely to disturb the registration during the computation.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        pointsRemoval->setStatusTip(QApplication::translate("RegistrationDialog", "Chose this option to remove points that are likely to disturb the registration during the computation.", nullptr));
#endif // QT_NO_STATUSTIP
        pointsRemoval->setText(QApplication::translate("RegistrationDialog", "Enable farthest points removal", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        checkBoxUseDataSFAsWeights->setText(QApplication::translate("RegistrationDialog", "Data: use displayed S.F. as weights", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        checkBoxUseModelSFAsWeights->setText(QApplication::translate("RegistrationDialog", "Model: use displayed S.F. as weights (only for clouds)", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabResearchParams), QApplication::translate("RegistrationDialog", "Research", nullptr));
    } // retranslateUi
