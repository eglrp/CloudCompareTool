...
public:
    ...
    {
        LabelingDialog->setWindowTitle(QApplication::translate("LabelingDialog", "Connected Components", nullptr));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("LabelingDialog", "Grid subdivision level: the greater, the finest", nullptr));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("LabelingDialog", "Octree Level", nullptr));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("LabelingDialog", "Minimum number of points per component", nullptr));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("LabelingDialog", "Min. points per component", nullptr));
        randomColorsCheckBox->setText(QApplication::translate("LabelingDialog", "random colors (warning: overwrites existing ones)", nullptr));
    } // retranslateUi
