...
public:
    ...
    {
        HistogramDialog->setWindowTitle(QApplication::translate("HistogramDialog", "Histogram", nullptr));
#ifndef QT_NO_TOOLTIP
        exportCSVToolButton->setToolTip(QApplication::translate("HistogramDialog", "Export histogram to a CSV file (can be imported into Excel ;)", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        exportImageToolButton->setToolTip(QApplication::translate("HistogramDialog", "Export histogram to an image file", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
