...
public:
    ...
    {
        GlobalShiftAndScaleDlg->setWindowTitle(QApplication::translate("GlobalShiftAndScaleDlg", "Global shift/scale", nullptr));
        messageLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Coordinates are too big (original precision may be lost)!", nullptr));
#ifndef QT_NO_TOOLTIP
        moreInfoToolButton->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "More information about this issue", nullptr));
#endif // QT_NO_TOOLTIP
        moreInfoToolButton->setText(QApplication::translate("GlobalShiftAndScaleDlg", "?", nullptr));
        label_4->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Do you wish to translate/rescale the entity?", nullptr));
        infoLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "shift/scale information is stored and used to restore the original coordinates at export time", nullptr));
#ifndef QT_NO_TOOLTIP
        bigCubeFrame->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "This version corresponds to the input (or output) file", nullptr));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Point in original\n"
"coordinate system (on disk)", nullptr));
        xOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "x = 3213132123.3215", nullptr));
        yOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "y = 3213213143.34", nullptr));
        zOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "z = 3.87", nullptr));
        diagOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "diagonal = 3213132123.3215", nullptr));
        label_3->setText(QApplication::translate("GlobalShiftAndScaleDlg", "x", nullptr));
        label1->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Shift", nullptr));
        label_5->setText(QApplication::translate("GlobalShiftAndScaleDlg", "+", nullptr));
        label1_2->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Scale", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        smallCubeFrame->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "This version is the one CloudCompare will work with. Mind the digits!", nullptr));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Point in local\n"
"coordinate system", nullptr));
        xDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "x = 123.3215", nullptr));
        yDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "y = 143.34", nullptr));
        zDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "z = 3.87", nullptr));
        diagDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "diagonal = 321313", nullptr));
        warningLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Warning: previously used shift and/or scale don't seem adapted to this entity", nullptr));
#ifndef QT_NO_TOOLTIP
        keepGlobalPosCheckBox->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "The local coordinates will be changed so as to keep the global coordinates the same", nullptr));
#endif // QT_NO_TOOLTIP
        keepGlobalPosCheckBox->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Keep original position fixed", nullptr));
    } // retranslateUi
