...
public:
    ...
    {
        SaveMascaretFileDlg->setWindowTitle(QApplication::translate("SaveMascaretFileDlg", "Save Mascaret profile", nullptr));
        label->setText(QApplication::translate("SaveMascaretFileDlg", "Reach/bief name", nullptr));
        biefNameLineEdit->setText(QApplication::translate("SaveMascaretFileDlg", "Profile", nullptr));
        label_2->setText(QApplication::translate("SaveMascaretFileDlg", "Bed type", nullptr));
        typeComboBox->setItemText(0, QApplication::translate("SaveMascaretFileDlg", "B (bathy)", nullptr));
        typeComboBox->setItemText(1, QApplication::translate("SaveMascaretFileDlg", "T (topo)", nullptr));
