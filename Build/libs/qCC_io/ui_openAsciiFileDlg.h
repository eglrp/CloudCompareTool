...
public:
    ...
    {
        AsciiOpenDialog->setWindowTitle(QApplication::translate("AsciiOpenDialog", "Open Ascii File", nullptr));
        label_3->setText(QApplication::translate("AsciiOpenDialog", "Filename:", nullptr));
        label->setText(QApplication::translate("AsciiOpenDialog", "Here are the first lines of this file. Choose each column attribution (one cloud at a time):", nullptr));
        headerLabel->setText(QApplication::translate("AsciiOpenDialog", "Header:", nullptr));
        label_2->setText(QApplication::translate("AsciiOpenDialog", "Separator", nullptr));
        asciiCodeLabel->setText(QApplication::translate("AsciiOpenDialog", "(ASCII code:%i)", nullptr));
        toolButtonShortcutESP->setText(QApplication::translate("AsciiOpenDialog", "ESP", nullptr));
        toolButtonShortcutTAB->setText(QApplication::translate("AsciiOpenDialog", "TAB", nullptr));
        toolButtonShortcutComma->setText(QApplication::translate("AsciiOpenDialog", ",", nullptr));
        toolButtonShortcutDotcomma->setText(QApplication::translate("AsciiOpenDialog", ";", nullptr));
...
#endif // QT_NO_TOOLTIP
        show2DLabelsCheckBox->setText(QApplication::translate("AsciiOpenDialog", "Show labels in 2D", nullptr));
        label_4->setText(QApplication::translate("AsciiOpenDialog", "Skip lines", nullptr));
        commentLinesSkippedLabel->setText(QApplication::translate("AsciiOpenDialog", "+ comment/header lines skipped: 0", nullptr));
        extractSFNamesFrom1stLineCheckBox->setText(QApplication::translate("AsciiOpenDialog", "extract scalar field names from first line", nullptr));
        label_5->setText(QApplication::translate("AsciiOpenDialog", "Max number of points per cloud", nullptr));
        maxCloudSizeDoubleSpinBox->setSuffix(QApplication::translate("AsciiOpenDialog", " Million", nullptr));
        applyButton->setText(QApplication::translate("AsciiOpenDialog", "Apply", nullptr));
        applyAllButton->setText(QApplication::translate("AsciiOpenDialog", "Apply all", nullptr));
        cancelButton->setText(QApplication::translate("AsciiOpenDialog", "Cancel", nullptr));
    } // retranslateUi
