...
public:
    ...
    void setupUi(QDialog *OpenLASFileDialog)
    {
        ...
        tileDimComboBox->addItem(QString());
        tileDimComboBox->addItem(QString());
        tileDimComboBox->addItem(QString());
    ...
    {
        OpenLASFileDialog->setWindowTitle(QApplication::translate("OpenLASFileDialog", "Open LAS File", nullptr));
        redCheckBox->setText(QApplication::translate("OpenLASFileDialog", "R", nullptr));
        greenCheckBox->setText(QApplication::translate("OpenLASFileDialog", "G", nullptr));
        blueCheckBox->setText(QApplication::translate("OpenLASFileDialog", "B", nullptr));
        classifCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Classification", nullptr));
        decomposeClassifGroupBox->setTitle(QApplication::translate("OpenLASFileDialog", "decompose", nullptr));
        classifValueCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Value", nullptr));
        classifSyntheticCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Synthetic flag", nullptr));
        classifKeypointCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Key-point", nullptr));
        classifWithheldCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Withheld", nullptr));
        timeCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Time", nullptr));
        pointSourceIDCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Point source ID", nullptr));
        numberOfReturnsCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Number of returns", nullptr));
        returnNumberCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Return number", nullptr));
        scanDirFlagCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Scan direction flag", nullptr));
        edgeOfFlightCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Edge of flight line", nullptr));
        scanAngleRankCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Scan angle rank", nullptr));
        userDataCheckBox->setText(QApplication::translate("OpenLASFileDialog", "User data", nullptr));
        intensityCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Intensity", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(stdTab), QApplication::translate("OpenLASFileDialog", "Standard fields", nullptr));
        extraFieldGroupBox->setTitle(QApplication::translate("OpenLASFileDialog", "Load additional field(s)", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(extTab), QApplication::translate("OpenLASFileDialog", "Extended fields", nullptr));
        tileGroupBox->setTitle(QApplication::translate("OpenLASFileDialog", "Tile input file", nullptr));
        label_4->setText(QApplication::translate("OpenLASFileDialog", "Dimension", nullptr));
        tileDimComboBox->setItemText(0, QApplication::translate("OpenLASFileDialog", "XY", nullptr));
        tileDimComboBox->setItemText(1, QApplication::translate("OpenLASFileDialog", "XZ", nullptr));
        tileDimComboBox->setItemText(2, QApplication::translate("OpenLASFileDialog", "YZ", nullptr));

        label_5->setText(QApplication::translate("OpenLASFileDialog", "Tiles", nullptr));
        label_6->setText(QApplication::translate("OpenLASFileDialog", "x", nullptr));
        label->setText(QApplication::translate("OpenLASFileDialog", "Output path", nullptr));
        browseToolButton->setText(QApplication::translate("OpenLASFileDialog", "...", nullptr));
        label_7->setText(QApplication::translate("OpenLASFileDialog", "Warning: the cloud won't be loaded in memory.\n"
"It will be saved as multiple tiles on the disk.", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tilingTab), QApplication::translate("OpenLASFileDialog", "Tiling", nullptr));
        label_2->setText(QApplication::translate("OpenLASFileDialog", "Points", nullptr));
        label_3->setText(QApplication::translate("OpenLASFileDialog", "Bounding-box", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(infoTab), QApplication::translate("OpenLASFileDialog", "Info", nullptr));
        ignoreDefaultFieldsCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Ignore fields with default values only", nullptr));
#ifndef QT_NO_TOOLTIP
        force8bitRgbCheckBox->setToolTip(QApplication::translate("OpenLASFileDialog", "Force reading colors as 8-bit values (even if the standard is 16-bit)", nullptr));
#endif // QT_NO_TOOLTIP
        force8bitRgbCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Force 8-bit colors", nullptr));
        applyButton->setText(QApplication::translate("OpenLASFileDialog", "Apply", nullptr));
        applyAllButton->setText(QApplication::translate("OpenLASFileDialog", "Apply all", nullptr));
        cancelButton->setText(QApplication::translate("OpenLASFileDialog", "Cancel", nullptr));
    } // retranslateUi
