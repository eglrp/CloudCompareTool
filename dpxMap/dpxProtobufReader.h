...
protected:
	...
	//bool AddPoles(hdmap_proto::Section* pSection,ccHObject* pFatherObj);
...
private:
	...
	bool CreateBorderLine( hdmap_proto::Rect* pRect,ccPointCloud* p3DVertices,ccPolyline* pBorderLine);
