...
class Map : public ::google::protobuf::Message {
 public:
  ...
  inline int parking_spaces_size() const;
  inline void clear_parking_spaces();
  static const int kParkingSpacesFieldNumber = 13;
  inline const ::hdmap_proto::ParkingSpace& parking_spaces(int index) const;
  inline ::hdmap_proto::ParkingSpace* mutable_parking_spaces(int index);
  inline ::hdmap_proto::ParkingSpace* add_parking_spaces();
  ...
  static const int kBordersFieldNumber = 14;
  inline const ::hdmap_proto::Lane& borders(int index) const;
  inline ::hdmap_proto::Lane* mutable_borders(int index);
  inline ::hdmap_proto::Lane* add_borders();
  ...
  static const int kTilesFieldNumber = 15;
  inline const ::hdmap_proto::Tile& tiles(int index) const;
  inline ::hdmap_proto::Tile* mutable_tiles(int index);
  inline ::hdmap_proto::Tile* add_tiles();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::hdmap_proto::ParkingSpace > parking_spaces_;
  ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Lane > borders_;
  ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Tile > tiles_;
  friend void  protobuf_AddDesc_map_2eproto();
  friend void protobuf_AssignDesc_map_2eproto();
  friend void protobuf_ShutdownFile_map_2eproto();
...
// repeated .hdmap_proto.LaneMarking lane_markings = 10;
inline int Map::lane_markings_size() const {
  return lane_markings_.size();
}
inline void Map::clear_lane_markings() {
  lane_markings_.Clear();
}
inline const ::hdmap_proto::LaneMarking& Map::lane_markings(int index) const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Map.lane_markings)
  return lane_markings_.Get(index);
}
inline ::hdmap_proto::LaneMarking* Map::mutable_lane_markings(int index) {
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Map.lane_markings)
  return lane_markings_.Mutable(index);
}
inline ::hdmap_proto::LaneMarking* Map::add_lane_markings() {
  // @@protoc_insertion_point(field_add:hdmap_proto.Map.lane_markings)
  return lane_markings_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::hdmap_proto::LaneMarking >&
Map::lane_markings() const {
  // @@protoc_insertion_point(field_list:hdmap_proto.Map.lane_markings)
  return lane_markings_;
}
inline ::google::protobuf::RepeatedPtrField< ::hdmap_proto::LaneMarking >*
Map::mutable_lane_markings() {
  // @@protoc_insertion_point(field_mutable_list:hdmap_proto.Map.lane_markings)
  return &lane_markings_;
}
...
// repeated .hdmap_proto.ParkingSpace parking_spaces = 13;
inline int Map::parking_spaces_size() const {
  return parking_spaces_.size();
}
inline void Map::clear_parking_spaces() {
  parking_spaces_.Clear();
}
inline const ::hdmap_proto::ParkingSpace& Map::parking_spaces(int index) const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Map.parking_spaces)
  return parking_spaces_.Get(index);
}
inline ::hdmap_proto::ParkingSpace* Map::mutable_parking_spaces(int index) {
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Map.parking_spaces)
  return parking_spaces_.Mutable(index);
}
inline ::hdmap_proto::ParkingSpace* Map::add_parking_spaces() {
  // @@protoc_insertion_point(field_add:hdmap_proto.Map.parking_spaces)
  return parking_spaces_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::hdmap_proto::ParkingSpace >&
Map::parking_spaces() const {
  // @@protoc_insertion_point(field_list:hdmap_proto.Map.parking_spaces)
  return parking_spaces_;
}
inline ::google::protobuf::RepeatedPtrField< ::hdmap_proto::ParkingSpace >*
Map::mutable_parking_spaces() {
  // @@protoc_insertion_point(field_mutable_list:hdmap_proto.Map.parking_spaces)
  return &parking_spaces_;
}

// repeated .hdmap_proto.Lane borders = 14;
inline int Map::borders_size() const {
  return borders_.size();
}
inline void Map::clear_borders() {
  borders_.Clear();
}
inline const ::hdmap_proto::Lane& Map::borders(int index) const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Map.borders)
  return borders_.Get(index);
}
inline ::hdmap_proto::Lane* Map::mutable_borders(int index) {
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Map.borders)
  return borders_.Mutable(index);
}
inline ::hdmap_proto::Lane* Map::add_borders() {
  // @@protoc_insertion_point(field_add:hdmap_proto.Map.borders)
  return borders_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Lane >&
Map::borders() const {
  // @@protoc_insertion_point(field_list:hdmap_proto.Map.borders)
  return borders_;
}
inline ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Lane >*
Map::mutable_borders() {
  // @@protoc_insertion_point(field_mutable_list:hdmap_proto.Map.borders)
  return &borders_;
}
...
inline const ::hdmap_proto::Tile& Map::tiles(int index) const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Map.tiles)
  return tiles_.Get(index);
}
inline ::hdmap_proto::Tile* Map::mutable_tiles(int index) {
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Map.tiles)
  return tiles_.Mutable(index);
}
inline ::hdmap_proto::Tile* Map::add_tiles() {
  // @@protoc_insertion_point(field_add:hdmap_proto.Map.tiles)
  return tiles_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Tile >&
Map::tiles() const {
  // @@protoc_insertion_point(field_list:hdmap_proto.Map.tiles)
  return tiles_;
}
inline ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Tile >*
Map::mutable_tiles() {
  // @@protoc_insertion_point(field_mutable_list:hdmap_proto.Map.tiles)
  return &tiles_;
}
