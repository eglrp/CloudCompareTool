...
// required .hdmap_proto.Polygon polygon = 4;
inline bool StopLine::has_polygon() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void StopLine::set_has_polygon() {
  _has_bits_[0] |= 0x00000004u;
}
inline void StopLine::clear_has_polygon() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void StopLine::clear_polygon() {
  if (polygon_ != NULL) polygon_->::hdmap_proto::Polygon::Clear();
  clear_has_polygon();
}
inline const ::hdmap_proto::Polygon& StopLine::polygon() const {
  // @@protoc_insertion_point(field_get:hdmap_proto.StopLine.polygon)
  return polygon_ != NULL ? *polygon_ : *default_instance_->polygon_;
}
inline ::hdmap_proto::Polygon* StopLine::mutable_polygon() {
  set_has_polygon();
  if (polygon_ == NULL) polygon_ = new ::hdmap_proto::Polygon;
  // @@protoc_insertion_point(field_mutable:hdmap_proto.StopLine.polygon)
  return polygon_;
}
inline ::hdmap_proto::Polygon* StopLine::release_polygon() {
  clear_has_polygon();
  ::hdmap_proto::Polygon* temp = polygon_;
  polygon_ = NULL;
  return temp;
}
inline void StopLine::set_allocated_polygon(::hdmap_proto::Polygon* polygon) {
  delete polygon_;
  polygon_ = polygon;
  if (polygon) {
    set_has_polygon();
  ...
  // @@protoc_insertion_point(field_set_allocated:hdmap_proto.StopLine.polygon)
}
