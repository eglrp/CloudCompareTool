...
// optional .hdmap_proto.Circle circle = 4;
inline bool TrafficLight::has_circle() const {
  return geometry_case() == kCircle;
}
inline void TrafficLight::set_has_circle() {
  _oneof_case_[0] = kCircle;
}
inline void TrafficLight::clear_circle() {
  if (has_circle()) {
    delete geometry_.circle_;
    clear_has_geometry();
  }
}
inline const ::hdmap_proto::Circle& TrafficLight::circle() const {
  return has_circle() ? *geometry_.circle_
                      : ::hdmap_proto::Circle::default_instance();
}
inline ::hdmap_proto::Circle* TrafficLight::mutable_circle() {
  if (!has_circle()) {
    clear_geometry();
    set_has_circle();
...
inline ::hdmap_proto::Circle* TrafficLight::release_circle() {
  if (has_circle()) {
    clear_has_geometry();
...
inline void TrafficLight::set_allocated_circle(::hdmap_proto::Circle* circle) {
  clear_geometry();
  if (circle) {
    set_has_circle();
...
// optional .hdmap_proto.Rect rect = 5;
inline bool TrafficLight::has_rect() const {
  return geometry_case() == kRect;
}
inline void TrafficLight::set_has_rect() {
  _oneof_case_[0] = kRect;
}
inline void TrafficLight::clear_rect() {
  if (has_rect()) {
    delete geometry_.rect_;
    clear_has_geometry();
  }
}
inline const ::hdmap_proto::Rect& TrafficLight::rect() const {
  return has_rect() ? *geometry_.rect_
                      : ::hdmap_proto::Rect::default_instance();
}
inline ::hdmap_proto::Rect* TrafficLight::mutable_rect() {
  if (!has_rect()) {
    clear_geometry();
    set_has_rect();
...
inline ::hdmap_proto::Rect* TrafficLight::release_rect() {
  if (has_rect()) {
    clear_has_geometry();
...
inline void TrafficLight::set_allocated_rect(::hdmap_proto::Rect* rect) {
  clear_geometry();
  if (rect) {
    set_has_rect();
