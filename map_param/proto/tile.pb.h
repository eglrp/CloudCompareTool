...
class Tile : public ::google::protobuf::Message {
 public:
  ...
  inline const ::hdmap_proto::Id& tile_id() const;
  inline ::hdmap_proto::Id* mutable_tile_id();
  inline ::hdmap_proto::Id* release_tile_id();
  inline void set_allocated_tile_id(::hdmap_proto::Id* tile_id);
  ...
  inline const ::hdmap_proto::Point& min_point() const;
  inline ::hdmap_proto::Point* mutable_min_point();
  inline ::hdmap_proto::Point* release_min_point();
  inline void set_allocated_min_point(::hdmap_proto::Point* min_point);
  ...
  // repeated .hdmap_proto.Id road_ids = 13;
  inline int road_ids_size() const;
  inline void clear_road_ids();
  static const int kRoadIdsFieldNumber = 13;
  inline const ::hdmap_proto::Id& road_ids(int index) const;
  inline ::hdmap_proto::Id* mutable_road_ids(int index);
  inline ::hdmap_proto::Id* add_road_ids();
  inline const ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Id >&
      road_ids() const;
  inline ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Id >*
      mutable_road_ids();
  ...
  static const int kSectionsIdsFieldNumber = 24;
 ...
 private:
  ...
  ::hdmap_proto::Id* tile_id_;
  ::hdmap_proto::Idx* idx_;
  ::hdmap_proto::Point* min_point_;
  ...
  ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Id > road_ids_;
...
inline const ::hdmap_proto::Id& Tile::tile_id() const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Tile.tile_id)
  return tile_id_ != NULL ? *tile_id_ : *default_instance_->tile_id_;
}
inline ::hdmap_proto::Id* Tile::mutable_tile_id() {
  set_has_tile_id();
  if (tile_id_ == NULL) tile_id_ = new ::hdmap_proto::Id;
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Tile.tile_id)
  return tile_id_;
}
inline ::hdmap_proto::Id* Tile::release_tile_id() {
  clear_has_tile_id();
  ::hdmap_proto::Id* temp = tile_id_;
  tile_id_ = NULL;
  return temp;
}
inline void Tile::set_allocated_tile_id(::hdmap_proto::Id* tile_id) {
  delete tile_id_;
  tile_id_ = tile_id;
  if (tile_id) {
    set_has_tile_id();
  ...
  // @@protoc_insertion_point(field_set_allocated:hdmap_proto.Tile.tile_id)
}
...
inline const ::hdmap_proto::Point& Tile::min_point() const {
...
inline ::hdmap_proto::Point* Tile::mutable_min_point() {
  set_has_min_point();
  if (min_point_ == NULL) min_point_ = new ::hdmap_proto::Point;
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Tile.min_point)
  return min_point_;
}
inline ::hdmap_proto::Point* Tile::release_min_point() {
  clear_has_min_point();
  ::hdmap_proto::Point* temp = min_point_;
  min_point_ = NULL;
  return temp;
}
inline void Tile::set_allocated_min_point(::hdmap_proto::Point* min_point) {
  delete min_point_;
...
inline const ::hdmap_proto::Id& Tile::road_ids(int index) const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Tile.road_ids)
  return road_ids_.Get(index);
}
inline ::hdmap_proto::Id* Tile::mutable_road_ids(int index) {
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Tile.road_ids)
  return road_ids_.Mutable(index);
}
inline ::hdmap_proto::Id* Tile::add_road_ids() {
  // @@protoc_insertion_point(field_add:hdmap_proto.Tile.road_ids)
  return road_ids_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Id >&
Tile::road_ids() const {
  // @@protoc_insertion_point(field_list:hdmap_proto.Tile.road_ids)
  return road_ids_;
}
inline ::google::protobuf::RepeatedPtrField< ::hdmap_proto::Id >*
Tile::mutable_road_ids() {
  // @@protoc_insertion_point(field_mutable_list:hdmap_proto.Tile.road_ids)
  return &road_ids_;
}
