...
void protobuf_AssignDesc_tile_2eproto() {
  ...
  static const int Tile_offsets_[20] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Tile, road_ids_),
...
void protobuf_AddDesc_tile_2eproto() {
  ...
  ::hdmap_proto::protobuf_AddDesc_road_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\030\002 \002(\0132\020.hdmap_proto.Idx\022%\n\tmin_point\030\004 "
    "\002(\0132\022.hdmap_proto.Point\022*\n\005range\030\005 \002(\0162\033"
    ".hdmap_proto.Tile.TileRange\022\037\n\006childs\030\006 "
    "\003(\0132\017.hdmap_proto.Id\022&\n\rcrosswalk_ids\030\n "
    "\003(\0132\017.hdmap_proto.Id\022%\n\014junction_ids\030\013 \003"
    "(\0132\017.hdmap_proto.Id\022)\n\020parkingspace_ids\030"
    "\014 \003(\0132\017.hdmap_proto.Id\022!\n\010road_ids\030\r \003(\013"
    "2\017.hdmap_proto.Id\022$\n\013refline_ids\030\016 \003(\0132\017"
    ".hdmap_proto.Id\022!\n\010lane_ids\030\017 \003(\0132\017.hdma"
    "p_proto.Id\022%\n\014stopline_ids\030\020 \003(\0132\017.hdmap"
    "_proto.Id\022&\n\rspeedbump_ids\030\021 \003(\0132\017.hdmap"
    "_proto.Id\022!\n\010pole_ids\030\022 \003(\0132\017.hdmap_prot"
    "o.Id\022\"\n\tboard_ids\030\023 \003(\0132\017.hdmap_proto.Id"
    "\022!\n\010zone_ids\030\024 \003(\0132\017.hdmap_proto.Id\022)\n\020l"
    "ane_marking_ids\030\025 \003(\0132\017.hdmap_proto.Id\022*"
    "\n\021traffic_light_ids\030\026 \003(\0132\017.hdmap_proto."
    "Id\022)\n\020traffic_sign_ids\030\027 \003(\0132\017.hdmap_pro"
    "to.Id\022%\n\014sections_ids\030\030 \003(\0132\017.hdmap_prot"
    "o.Id\"-\n\tTileRange\022\006\n\002T0\020(\022\006\n\002T1\020P\022\007\n\002T2\020"
    "\240\001\022\007\n\002T3\020\300\002", 971);
...
const int Tile::kRoadIdsFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 12: {
        ...
        if (input->ExpectTag(98)) goto parse_parkingspace_ids;
        if (input->ExpectTag(106)) goto parse_road_ids;
        break;
      }
...
void Tile::SerializeWithCachedSizes(
  ...
  // repeated .hdmap_proto.Id road_ids = 13;
  for (int i = 0; i < this->road_ids_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      13, this->road_ids(i), output);
  }
...
int Tile::ByteSize() const {
  ...
  // repeated .hdmap_proto.Id road_ids = 13;
  total_size += 1 * this->road_ids_size();
  for (int i = 0; i < this->road_ids_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->road_ids(i));
...
void Tile::MergeFrom(const Tile& from) {
  ...
  road_ids_.MergeFrom(from.road_ids_);
...
bool Tile::IsInitialized() const {
  ...
  if (!::google::protobuf::internal::AllAreInitialized(this->road_ids())) return false;
...
void Tile::Swap(Tile* other) {
  if (other != this) {
    ...
    road_ids_.Swap(&other->road_ids_);
