...
inline const ::hdmap_proto::TrafficLight& Section::traffic_signs(int index) const {
  // @@protoc_insertion_point(field_get:hdmap_proto.Section.traffic_signs)
  return traffic_signs_.Get(index);
}
inline ::hdmap_proto::TrafficLight* Section::mutable_traffic_signs(int index) {
  // @@protoc_insertion_point(field_mutable:hdmap_proto.Section.traffic_signs)
  return traffic_signs_.Mutable(index);
}
inline ::hdmap_proto::TrafficLight* Section::add_traffic_signs() {
