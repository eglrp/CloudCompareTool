...
class TrafficSign : public ::google::protobuf::Message {
 public:
  ...
  static const int kCircleFieldNumber = 5;
  inline const ::hdmap_proto::Circle& circle() const;
  inline ::hdmap_proto::Circle* mutable_circle();
  inline ::hdmap_proto::Circle* release_circle();
  inline void set_allocated_circle(::hdmap_proto::Circle* circle);

  // optional .hdmap_proto.Rect rect = 6;
  inline bool has_rect() const;
  inline void clear_rect();
  static const int kRectFieldNumber = 6;
  inline const ::hdmap_proto::Rect& rect() const;
  inline ::hdmap_proto::Rect* mutable_rect();
  inline ::hdmap_proto::Rect* release_rect();
  inline void set_allocated_rect(::hdmap_proto::Rect* rect);

  // optional .hdmap_proto.Cube cube = 7;
  inline bool has_cube() const;
  inline void clear_cube();
  static const int kCubeFieldNumber = 7;
  inline const ::hdmap_proto::Cube& cube() const;
  inline ::hdmap_proto::Cube* mutable_cube();
  inline ::hdmap_proto::Cube* release_cube();
  inline void set_allocated_cube(::hdmap_proto::Cube* cube);
 ...
 private:
  ...
  union GeometryUnion {
    ::hdmap_proto::Circle* circle_;
    ::hdmap_proto::Rect* rect_;
    ::hdmap_proto::Cube* cube_;
...
// optional .hdmap_proto.Circle circle = 5;
inline bool TrafficSign::has_circle() const {
  return geometry_case() == kCircle;
}
inline void TrafficSign::set_has_circle() {
  _oneof_case_[0] = kCircle;
}
inline void TrafficSign::clear_circle() {
  if (has_circle()) {
    delete geometry_.circle_;
    clear_has_geometry();
  }
}
inline const ::hdmap_proto::Circle& TrafficSign::circle() const {
  return has_circle() ? *geometry_.circle_
                      : ::hdmap_proto::Circle::default_instance();
}
inline ::hdmap_proto::Circle* TrafficSign::mutable_circle() {
  if (!has_circle()) {
    clear_geometry();
    set_has_circle();
    geometry_.circle_ = new ::hdmap_proto::Circle;
  }
  return geometry_.circle_;
}
inline ::hdmap_proto::Circle* TrafficSign::release_circle() {
  if (has_circle()) {
    clear_has_geometry();
    ::hdmap_proto::Circle* temp = geometry_.circle_;
...
inline void TrafficSign::set_allocated_circle(::hdmap_proto::Circle* circle) {
  clear_geometry();
  if (circle) {
    set_has_circle();
...
// optional .hdmap_proto.Rect rect = 6;
inline bool TrafficSign::has_rect() const {
  return geometry_case() == kRect;
}
inline void TrafficSign::set_has_rect() {
  _oneof_case_[0] = kRect;
}
inline void TrafficSign::clear_rect() {
  if (has_rect()) {
    delete geometry_.rect_;
    clear_has_geometry();
  }
}
inline const ::hdmap_proto::Rect& TrafficSign::rect() const {
  return has_rect() ? *geometry_.rect_
                      : ::hdmap_proto::Rect::default_instance();
}
inline ::hdmap_proto::Rect* TrafficSign::mutable_rect() {
  if (!has_rect()) {
    clear_geometry();
    set_has_rect();
    geometry_.rect_ = new ::hdmap_proto::Rect;
  }
  return geometry_.rect_;
}
inline ::hdmap_proto::Rect* TrafficSign::release_rect() {
  if (has_rect()) {
    clear_has_geometry();
    ::hdmap_proto::Rect* temp = geometry_.rect_;
    geometry_.rect_ = NULL;
    return temp;
  } else {
    return NULL;
  }
}
inline void TrafficSign::set_allocated_rect(::hdmap_proto::Rect* rect) {
  clear_geometry();
  if (rect) {
    set_has_rect();
    geometry_.rect_ = rect;
  }
}

// optional .hdmap_proto.Cube cube = 7;
inline bool TrafficSign::has_cube() const {
  return geometry_case() == kCube;
}
inline void TrafficSign::set_has_cube() {
  _oneof_case_[0] = kCube;
}
inline void TrafficSign::clear_cube() {
  if (has_cube()) {
    delete geometry_.cube_;
    clear_has_geometry();
  }
}
inline const ::hdmap_proto::Cube& TrafficSign::cube() const {
  return has_cube() ? *geometry_.cube_
                      : ::hdmap_proto::Cube::default_instance();
}
inline ::hdmap_proto::Cube* TrafficSign::mutable_cube() {
  if (!has_cube()) {
    clear_geometry();
    set_has_cube();
    geometry_.cube_ = new ::hdmap_proto::Cube;
  }
  return geometry_.cube_;
}
inline ::hdmap_proto::Cube* TrafficSign::release_cube() {
  if (has_cube()) {
    clear_has_geometry();
    ::hdmap_proto::Cube* temp = geometry_.cube_;
    geometry_.cube_ = NULL;
    return temp;
  } else {
    return NULL;
  }
}
inline void TrafficSign::set_allocated_cube(::hdmap_proto::Cube* cube) {
  clear_geometry();
  if (cube) {
    set_has_cube();
    geometry_.cube_ = cube;
  }
}
...
inline void TrafficSign::set_has_polygon() {
  _oneof_case_[0] = kPolygon;
}
inline void TrafficSign::clear_polygon() {
  if (has_polygon()) {
    delete geometry_.polygon_;
    clear_has_geometry();
  }
}
inline const ::hdmap_proto::Polygon& TrafficSign::polygon() const {
  return has_polygon() ? *geometry_.polygon_
                      : ::hdmap_proto::Polygon::default_instance();
}
inline ::hdmap_proto::Polygon* TrafficSign::mutable_polygon() {
  if (!has_polygon()) {
    clear_geometry();
    set_has_polygon();
    geometry_.polygon_ = new ::hdmap_proto::Polygon;
  }
  return geometry_.polygon_;
}
inline ::hdmap_proto::Polygon* TrafficSign::release_polygon() {
  if (has_polygon()) {
    clear_has_geometry();
    ::hdmap_proto::Polygon* temp = geometry_.polygon_;
    geometry_.polygon_ = NULL;
    return temp;
  } else {
    return NULL;
  }
}
inline void TrafficSign::set_allocated_polygon(::hdmap_proto::Polygon* polygon) {
  clear_geometry();
  if (polygon) {
    set_has_polygon();
